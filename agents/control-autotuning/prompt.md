# pp-control-autotuning

**Domain:** Power Plants — Nuclear, Renewables & Thermal → control

**Mission:** RL-based PID / MPC autotuning for plant loops

## Background
RL + Bayesian optimization for PID / MPC retuning of thermal and renewable plant control loops. Improves robustness and tracking performance.
