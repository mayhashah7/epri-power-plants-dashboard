# pp-generation-fault-diagnosis

**Domain:** Power Plants — Nuclear, Renewables & Thermal → fault

**Mission:** Cross-fleet fault-signature matching

## Background
Data-driven fault-signature library across thermal / hydro / wind / solar / nuclear fleets. Rapid root-cause classification from sensor traces.
