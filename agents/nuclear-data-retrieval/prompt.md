# pp-nuclear-data-retrieval

**Domain:** Power Plants — Nuclear, Renewables & Thermal → nuc_data

**Mission:** NL-to-query over plant historian / databases

## Background
Natural-language queries over plant historian, EAM, training records. Returns precise extracts with provenance citations.
