# pp-nuclear-design-validation

**Domain:** Power Plants — Nuclear, Renewables & Thermal → nuc_design

**Mission:** AI design-control V&V methodology

## Background
Methodology + tooling to safely integrate AI tools into nuclear design processes. V&V framework with auditable evidence trails.
