# pp-nuclear-spare-part-reordering

**Domain:** Power Plants — Nuclear, Renewables & Thermal → spares

**Mission:** Predictive spares forecast — kill stockouts & excess

## Background
Forecasts spare part demand from work-order history, asset population, lead-time distributions. Optimizes reorder points and safety stock.
