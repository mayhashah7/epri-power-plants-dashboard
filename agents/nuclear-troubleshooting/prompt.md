# pp-nuclear-troubleshooting

**Domain:** Power Plants — Nuclear, Renewables & Thermal → troubleshoot

**Mission:** Conversational troubleshooting assistant

## Background
Query-based system for nuclear operators / engineers. Retrieves data, runs failure analyses, recommends tools, learns from feedback.
