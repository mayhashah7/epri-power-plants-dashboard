...
ORCHESTRATOR_NAME = "pp-orchestrator"

# Full AMI agent fabric (12 total: orchestrator + 11 specialists)
AGENT_ROSTER = [
    {"name": "pp-orchestrator", "domain": "routing", "icon": "🏭", "color": "#a855f7"},
    {"name": "pp-solar-pv-defect-detection", "domain": "solar", "icon": "🔆", "color": "#facc15"},
    {"name": "pp-solar-pv-connector-quality", "domain": "connector", "icon": "🔌", "color": "#fb923c"},
    {"name": "pp-generation-fault-diagnosis", "domain": "fault", "icon": "🛠️", "color": "#0ea5e9"},
    {"name": "pp-transformer-dga-monitoring", "domain": "dga", "icon": "💧", "color": "#14b8a6"},
    {"name": "pp-control-autotuning", "domain": "control", "icon": "🎛️", "color": "#06b6d4"},
    {"name": "pp-nuclear-deliverables-enhancement", "domain": "nuc_docs", "icon": "📑", "color": "#a855f7"},
    {"name": "pp-nuclear-design-validation", "domain": "nuc_design", "icon": "🧪", "color": "#c084fc"},
    {"name": "pp-nuclear-spare-part-reordering", "domain": "spares", "icon": "📦", "color": "#d946ef"},
    {"name": "pp-nuclear-troubleshooting", "domain": "troubleshoot", "icon": "🧯", "color": "#e879f9"},
    {"name": "pp-nuclear-data-retrieval", "domain": "nuc_data", "icon": "🔎", "color": "#a78bfa"},
]
...
class FoundryAgentRunner:
    ...
    async def _mock_chat(self, *, text: str, persona: str | None, case_id: str | None) -> AsyncIterator[dict]:
        ...
        _routes = [
            (["solar", "defect", "detection"], "solar", "pp-solar-pv-defect-detection"),
            (["solar", "connector", "quality"], "connector", "pp-solar-pv-connector-quality"),
            (["generation", "fault", "diagnosis"], "fault", "pp-generation-fault-diagnosis"),
            (["transformer", "monitoring"], "dga", "pp-transformer-dga-monitoring"),
            (["control", "autotuning"], "control", "pp-control-autotuning"),
            (["nuclear", "deliverables", "enhancement"], "nuc_docs", "pp-nuclear-deliverables-enhancement"),
            (["nuclear", "design", "validation"], "nuc_design", "pp-nuclear-design-validation"),
            (["nuclear", "spare", "part", "reordering"], "spares", "pp-nuclear-spare-part-reordering"),
            (["nuclear", "troubleshooting"], "troubleshoot", "pp-nuclear-troubleshooting"),
            (["nuclear", "data", "retrieval"], "nuc_data", "pp-nuclear-data-retrieval"),
        ]
        kind, target = "solar", "pp-solar-pv-defect-detection"
...
EVENT_TO_PROMPT: dict[str, tuple[str, str]] = {
    "pv-defect-batch": ("Process this morning's drone EL imagery — flag hotspots", "pp-solar-pv-defect-detection"),
    "connector-qa": ("Assess installer batch B-2024-09 X-rays", "pp-solar-pv-connector-quality"),
    "fault-diagnosis": ("Steam-turbine vibration spike on Unit 3 — diagnose", "pp-generation-fault-diagnosis"),
    "dga-spike": ("Acetylene rose 3× on GSU TX-7 — classify", "pp-transformer-dga-monitoring"),
    "pid-tune": ("Boiler pressure loop oscillating — propose retune", "pp-control-autotuning"),
    "nuc-troubleshoot": ("Reactor coolant pump seal flow trending up — investigate", "pp-nuclear-troubleshooting"),
    "nuc-data-pull": ("Pull last 60d RCS chemistry against EPRI guidelines", "pp-nuclear-data-retrieval"),
    "spare-forecast": ("Forecast next 90d spares for Unit 2 outage", "pp-nuclear-spare-part-reordering"),
}
